...
function startHold(e) {
  if (e.target.closest(".progress-thumb")) holdBar = true;
  if (e.target.closest(".volume-thumb") || e.target.closest(".volume-track")) holdSound = true;
}
...
function moveHold(e) {
  ...
  if (holdSound) setSound(e.clientX);
}
